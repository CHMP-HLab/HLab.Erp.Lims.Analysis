...
namespace NPoco.RowMappers
{
    ...
    {
        Func<DbDataReader, object> mapper = default!;
        MapperCollection mappers;

        static Cache<(Type, MapperCollection), Func<DbDataReader, object>> cache
        ...
        static Func<DbDataReader, object> GetRowMapper(Type type, MapperCollection mappers, DbDataReader dataReader)
        {
            return cache.Get((type, mappers), () => CreateRowMapper(type, mappers, dataReader));
        }

        static Func<DbDataReader, object> CreateRowMapper(Type type, MapperCollection mappers, DbDataReader dataReader)
        {
        ...
        static (NewExpression expr, int fieldsIndex) CreateTupleExpression(Type type, MapperCollection mappers, DbDataReader dataReader, ParameterExpression reader, int fieldIndex)
        {
