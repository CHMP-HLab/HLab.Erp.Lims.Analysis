...
namespace HLab.Erp.Lims.Analysis.Data
{
    ...
    public partial class StatQuery : Entity, IListableModel, ILocalCache
    {
        ...
        readonly IProperty<string> _nom = H.Property<string>(c => c.Default(""));
        public string P1
        {
            get => _p1.Get(); set => _p1.Set(value);
        }

        readonly IProperty<string> _p1 = H.Property<string>(c => c.Default(""));
        public string P2
        {
            get => _p2.Get(); set => _p2.Set(value);
        }

        readonly IProperty<string> _p2 = H.Property<string>(c => c.Default(""));
        public string P3
        {
            get => _p3.Get(); set => _p3.Set(value);
        }

        readonly IProperty<string> _p3 = H.Property<string>(c => c.Default(""));
        public string P4
        {
            get => _p4.Get(); set => _p4.Set(value);
        }

        readonly IProperty<string> _p4 = H.Property<string>(c => c.Default(""));
        public int T1
        {
            get => _t1.Get(); set => _t1.Set(value);
        }

        readonly IProperty<int> _t1 = H.Property<int>();
        public int T2
        {
            get => _t2.Get(); set => _t2.Set(value);
        }

        readonly IProperty<int> _t2 = H.Property<int>();
        public int T3
        {
            get => _t3.Get(); set => _t3.Set(value);
        }

        readonly IProperty<int> _t3 = H.Property<int>();
        public int T4
        {
            get => _t4.Get(); set => _t4.Set(value);
        }

        readonly IProperty<int> _t4 = H.Property<int>();
        public string Query
        {
            get => _query.Get(); set => _query.Set(value);
        }

        readonly IProperty<string> _query = H.Property<string>(c => c.Default(""));
        public string Parametres
        {
            get => _parametres.Get(); set => _parametres.Set(value);
        }

        readonly IProperty<string> _parametres = H.Property<string>(c => c.Default(""));
        public string TaillesColonnes
        {
            get => _taillesColonnes.Get(); set => _taillesColonnes.Set(value);
        }

        readonly IProperty<string> _taillesColonnes = H.Property<string>(c => c.Default(""));
        //public string Droit
        //{
